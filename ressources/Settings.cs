...
namespace Marvin_Tabelle_zu_xml
{
    class Settings
    {
        ...
        public void readSettingsFromFile()
        {
            ...
            //TODOs:
            // - make it lock more pretty
            // - make programm to use it
            // - makte error detection, if one of those strings is empty or file does not exist
            // Create xDoc
            XmlDocument xDoc = new XmlDocument();
            // Open file
            xDoc.Load(@"C:\Users\Benedikt\source\repos\Marvin Tabelle zu xml\Settings.xml");
